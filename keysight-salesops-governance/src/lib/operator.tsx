...
export type SfUser = {
  ...
  /** Resolved RBAC role for this user. Source of truth = Salesforce
   *  Permission Set assignments, with legacy allowlist as fallback. */
  role?: "viewer" | "zbrain_admin";
  permission_sets?: string[];
  role_source?: {
    source: string;          // 'sf_permission_set' | 'fallback_allowlist' | 'sf_offline' | ...
    matched?: string | null; // permission set name OR allowlist label
    username?: string | null;
    permission_sets?: string[];
  };
};
